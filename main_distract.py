...
while True:
    ...
    for rect in rects:
        ...
        if ear < EYE_AR_THRESH:  # 眼睛长宽比：0.2
            ...
            if COUNTER >= EYE_AR_CONSEC_FRAMES and temp_k_flag == 0:  # 阈值：3
                TOTAL += 1
            # 重置眼帧计数器
            COUNTER = 0
        ...
        cv2.putText(frame, "Tired eye num: {}".format(TOTAL), (450, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)
    ...
    if TOTAL >= 25 or mTOTAL >= 15 or hTOTAL >= 15:
